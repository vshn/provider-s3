...
[![Build](https://img.shields.io/github/workflow/status/vshn/provider-s3/Test)][build]
![Go version](https://img.shields.io/github/go-mod/go-version/vshn/provider-s3)
[![Version](https://img.shields.io/github/v/release/vshn/provider-s3)][releases]
[![GitHub downloads](https://img.shields.io/github/downloads/vshn/provider-s3/total)][releases]

[build]: https://github.com/vshn/provider-s3/actions?query=workflow%3ATest
[releases]: https://github.com/vshn/provider-s3/releases

Crossplane provider for managing resources on s3.

Documentation: https://vshn.github.io/vshn/provider-s3/
...
* `make crossplane-setup minio-setup install-crds` to install crossplane and s3 in the kind cluster
* `kubectl apply -f samples/_secret.yaml samples/s3.crossplane.io_providerconfig.yaml`
